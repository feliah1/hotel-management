        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form method="POST" action="{{ route('tenants.store') }}">
                    ...
                    <!-- Contacts -->
                    <div>
                        <x-input-label for="contacts" :value="__('Phone Number')" />
                        <x-text-input id="contacts" class="block mt-1 w-full" type="text" name="contacts" :value="old('contacts')" required autofocus autocomplete="contacts" />
